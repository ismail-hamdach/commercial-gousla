        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="page-header">
                <div class="d-flex justify-content-between text-center">
                    <h2 class="pageheader-title">Gestion des retours</h2>
                                    ...
                                    <tbody>
                                        @foreach ($Orders as $order)
                                            <tr>
                                                ...
                                                <td class="text-center">{{ number_format( $order->profit , 2 ) }} DH</td>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="" id="large" method="GET">
                            @csrf
...
@section('js_order_page')
    <script>
        ...
        $('#modal_details').on('show.bs.modal', function(event) {
            ...
            modal.find('#large').attr('action', '/orders/PDF/' + orderID)
...
@section('js_orderDetails_page')
    <script>
                ...
                success: function(response) {
                    ...
                    $.each(response.DetailsOrder, function(key, item) {
                        $('#Data_Order').append("<tr><td>" + item.product_name +
                            ...
                            item.id +
                            "'/><input type='number' class='input_QNT_router' @disabled(!auth()->user()->hasRole('master|admin|gerant BL')) onKeyUp='(event)=>{if(event.target.value<1)event.target.value=1;}' min='1' style='width:60px;' value='" +
        ...
        $(".table").on('change', '.input_QNT_router', function(e) {
            e.preventDefault();
            let hasAccess="{{auth()->user()->hasRole('admin|gerant bL|master')}}";

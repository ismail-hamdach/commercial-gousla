                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="priceAchat" class="form-control" id="validationCustom05"
                                            value="{{ $product->priceAchat }}" placeholder="Price d'Achat">
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    @if (count($users) > 0 )
                                        <div class="col-md-6">
                                            <label for="" class="mt-3">Choisir l'employeer <span
                                                    style="color:red;">*</span></label>
                                            <div class="d-flex ">
                                                <select onchange="findCategoriesOfEmployee(event.target.value); findStocksOfEmployee(event.target.value)" required name="user" id="users" class="form-control">

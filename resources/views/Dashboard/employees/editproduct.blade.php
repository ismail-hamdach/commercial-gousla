    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <div class="card">
                ...
                <div class="card-body ">
                    <form class="needs-validation" action="{{ route('employees.updateproduct', $product->id) }}"
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="ref" id="validationCustom03"
                                            placeholder="Référence" value="{{ $product->ref }}" required>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="name" id="validationCustom04"
                                            placeholder="Nom de produit" value="{{ $product->name }}" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <label for="validationCustom03" class="mt-3">Prix d'achat<span
                                                style="color:red;">*</span></label>
                                        <input type="text" name="priceAchat" class="form-control" id="validationCustom03"
                                            placeholder="priceAchat" value="{{ $product->priceAchat }}" required>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="percentage" class="form-control" id="validationCustom03"
                                            value="{{ $product->percentage }}" placeholder="Percentage">
                                    </div>
                                    <div class="col-md-4">
                                        <label for="validationCustom03" class="mt-3">Quantité <span
                                                style="color:red;">*</span></label>
                                        <input type="text" name="QNT" class="form-control" id="validationCustom03"
                                            value="{{ $product->QNT }}" placeholder="Quantité">
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="d-flex ">
                                            <select
                                                ...
                                                required name="user" id="users" class="form-control">
                                                <option>Choisir employees</option>
                                                @foreach ($users as $user)
                                                    <option @if ($product->user_id == $user->id) selected @endif
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 mt-3">
                                <div class="imgUp">
                                    <div class="imagePreview"
                                        style="background: url('{{ asset('product_image/' . $product->image) }}'); background-size:cover;">
                                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="">
                        ...
                        <input type="text" name="depot" id="name" class="form-control" placeholder="Nom"
                            required>
    ...
    <script>
        ...
        function findStocksOfEmployee(id) {
            $.ajax({
                ...
                dataType: 'json',
                success: function(response) {
                    $('#depot').append('<option value="0">Choisir depot</option>')

                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <h5 class="mb-0"></h5>
                            <a href="{{ route('employees.newproduct') }}" class=" text-success">Ajouter un produit <i
                                                ...
                                                @if (Auth::user()->hasRole('admin|gerant product') || Auth::user()->hasRole('master'))
                                                    <td style="width:10%;">
                                                        <div class="d-flex justify-content-between">
                                                            <a href="{{ route('employees.editproduct', $product->id) }}"
...
@section('js_product_page')
    <script>
        $('#deletemodal').on('show.bs.modal', function(event) {
            ...
            modal.find('form').attr('action', '/employees/deleteproduct/' + productID)
        });
    </script>

                            ...
                            <form action="" class="d-flex justify-center mb-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-12 d-flex justify-center align-middle">
                                        ...
                                        <a href="{{ route('employeescategories.index') }}"
                                            class="btn btn-warning mt-3 btn_cancel rounded">Annuler</a>
                                    </div>
                                </div>
                            </form>
                            <h5 class="mb-0"></h5>
                            <a href="{{ route('employeescategories.create') }}" class=" text-success">Ajouter un categorie <i
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:10%;">
                                                    <div class="d-flex justify-content-between">
                                                        <a href="{{ route('employeescategories.edit', $category->id) }}"
                                                            class="btn btn-primary rounded">Editer</a>
                                                        <a href="#" class="btn btn-danger rounded "
                                                            data-toggle="modal" data-categoryId="{{ $category->id }}"

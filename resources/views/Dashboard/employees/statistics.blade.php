    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="page-header">
                <h2 class="pageheader-title">Table de board d'employees</h2>
                <hr>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    ...
                    @if ($percentage > 0)
                        <div class="metric-label d-inline-block float-right text-success font-weight-bold">
                            <span><i
                                    class="fa fa-fw fa-arrow-up"></i></span><span>{{ number_format((float) $percentage, 2, ',', '') }}%</span>
                        </div>
                    @else
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:10%;">
                                            <div class="d-flex justify-content-between">
                                                <a href="" data-toggle="modal" data-orderId="{{ $order->ref }}"
                                                    data-target="#modal_details"
                                                    class="btn btn-primary rounded btn_details">Détails</a>

                                                <a href="#" data-toggle="modal" data-orderId="{{ $order->id }}"
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(response.DetailsOrder, function(key, item) {
                        $('#Data_Order').append("<tr><td>" + item.id + "</td><td>" + item
                            .product_name + "</td><td>" + item.QNT + "</td><td>" + item
                            .price + " DH</td><td>" + item.total + " DH</td></tr>");
                    });
